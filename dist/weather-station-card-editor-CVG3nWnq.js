import{b as e,i as t,e as s,r as o,l as i}from"./main-bZPfZGvU.js";function a(t){const{editor:s,title:o,sectionKey:i,resetLabel:a}=t;return e`
  ...
  `}const n=new Set(["temperature"]);const r=[{name:"openmeteo_history",selector:{boolean:{}}}],c=[{name:"weather_entity",required:!0,selector:{entity:{domain:"weather"}}}],h=[{name:"number_of_forecasts",selector:{number:{min:0,mode:"box"}}}],d=[{name:"condition_icons",selector:{boolean:{}}},{name:"show_wind_arrow",selector:{boolean:{}}},{name:"show_wind_speed",selector:{boolean:{}}},{name:"show_date",selector:{boolean:{}}},{name:"show_sunshine",selector:{boolean:{}}},{name:"show_mode_toggle",selector:{boolean:{}}}],l=[{name:"pressure",selector:{select:{mode:"dropdown",options:["hPa","mmHg","inHg"]}}},{name:"speed",selector:{select:{mode:"dropdown",options:["km/h","m/s","mph","Bft"]}}},{name:"precipitation",selector:{select:{mode:"dropdown",options:["mm","in"]}}}],_={pressure:"Convert pressure to",speed:"Convert wind speed to",precipitation:"Convert precipitation to"},u={card_setup:["show_station","show_forecast","forecast.type"],weather_forecast:["weather_entity"],sensors:["sensors","forecast.openmeteo_history"],chart:["title","days","forecast_days","forecast.number_of_forecasts","forecast.condition_icons","forecast.show_wind_arrow","forecast.show_wind_speed","forecast.show_date","forecast.show_sunshine","forecast.show_mode_toggle","forecast.style","forecast.round_temp","forecast.disable_animation"],live_panel:["show_main","show_temperature","show_current_condition","show_time","show_time_seconds","use_12hour_format","show_day","show_date","show_attributes","show_humidity","show_pressure","show_dew_point","show_precipitation","show_uv_index","show_illuminance","show_sunshine_duration","show_wind_direction","show_wind_speed","show_wind_gust_speed","show_sun"],units:["units"],actions:["tap_action","hold_action","double_tap_action"]};customElements.define("weather-station-card-editor",class extends t{constructor(){super(...arguments),this.hass=null,this._config=null,this._sensorsChanged=e=>{if(!this._config)return;const t=e.target;if("ha-form"!==t?.tagName.toLowerCase())return;const s=e.detail;this.configChanged({...this._config,sensors:s.value}),this.requestUpdate()},this._sensorPickerChanged=(e,t)=>{if(!this._config)return;const s={...this._config.sensors||{}};""===t||null==t?delete s[e]:s[e]=t,this.configChanged({...this._config,sensors:s}),this.requestUpdate()},this._unitsChanged=e=>{if(!this._config)return;const t=e.target;if("ha-form"!==t?.tagName.toLowerCase())return;const s=e.detail;this.configChanged({...this._config,units:s.value}),this.requestUpdate()},this._chartTopChanged=e=>{if(!this._config)return;const t=e.target;if("ha-form"!==t?.tagName.toLowerCase())return;const s=e.detail,o={...this._config};for(const[e,t]of Object.entries(s.value))void 0===t||""===t?delete o[e]:o[e]=t;this.configChanged(o),this.requestUpdate()},this._chartForecastChanged=e=>{if(!this._config)return;const t=e.target;if("ha-form"!==t?.tagName.toLowerCase())return;const s=e.detail,o={...this._config.forecast||{}};for(const[e,t]of Object.entries(s.value))void 0===t||""===t?delete o[e]:o[e]=t;this.configChanged({...this._config,forecast:o}),this.requestUpdate()},this._livePanelChanged=e=>{if(!this._config)return;const t=e.target;if("ha-form"!==t?.tagName.toLowerCase())return;const s=e.detail,o={...this._config};for(const[e,t]of Object.entries(s.value))void 0===t||""===t?delete o[e]:o[e]=t;this.configChanged(o),this.requestUpdate()},this._resetSection=e=>{if(!this._config)return;const t=u[e];if(!t)return;const s=JSON.parse(JSON.stringify(this._config));for(const e of t)this._deleteByPath(s,e);this.configChanged(s),this.requestUpdate()},this._valueChanged=(e,t)=>{if(!this._config)return;const s={...this._config},o=e.target.checked??e.target.value;if(t.includes(".")){const e=t.split(".");let i=s;for(let t=0;t<e.length-1;t++)i[e[t]]={...i[e[t]]},i=i[e[t]];i[e[e.length-1]]=o}else s[t]=o;this.configChanged(s),this.requestUpdate()},this._actionChanged=(e,t)=>{if(!this._config)return;const s={...this._config};null==t?delete s[e]:s[e]=t,this.configChanged(s),this.requestUpdate()},this._conditionMappingChanged=(e,t)=>{if(!this._config)return;const s=e.target.value,o={...this._config.condition_mapping||{}};if(""===s||null==s)delete o[t];else{const e=parseFloat(s);Number.isFinite(e)&&(o[t]=e)}const i={...this._config};0===Object.keys(o).length?delete i.condition_mapping:i.condition_mapping=o,this.configChanged(i),this.requestUpdate()}}static get properties(){return{_config:{type:Object},hass:{type:Object}}}setConfig(e){if(!e)throw new Error("Invalid configuration");this._config=e;const t=this.hass?.language||"en";"en"!==t&&"en"!==t.split("-")[0]&&s(t).then(()=>this.requestUpdate()),this.requestUpdate()}get config(){return this._config}get _mode(){if(!this._config)return"station";const e=!1!==this._config.show_station,t=!0===this._config.show_forecast;return e&&t?"combination":t?"forecast":"station"}_setMode(e){if(!this._config)return;const t={...this._config};switch(e){case"station":t.show_station=!0,t.show_forecast=!1;break;case"forecast":t.show_station=!1,t.show_forecast=!0;break;case"combination":t.show_station=!0,t.show_forecast=!0}this.configChanged(t),this.requestUpdate()}_pastDataAvailable(){if(!this._config)return!0;const e=this._config.sensors||{},t=Object.values(e).some(e=>"string"==typeof e&&""!==e.trim()),s=this._config.forecast;return t||!0===s?.openmeteo_history}updated(e){e.has("_config")&&this._config&&!this._pastDataAvailable()&&"forecast"!==this._mode&&this._setMode("forecast")}configChanged(e){const t=new Event("config-changed",{bubbles:!0,composed:!0});t.detail={config:e},this.dispatchEvent(t)}_deleteByPath(e,t){const s=t.split("."),o=[e];let i=e;for(let e=0;e<s.length-1;e++){const t=i?.[s[e]];if(!t||"object"!=typeof t)return;i=t,o.push(i)}delete i[s[s.length-1]];for(let e=o.length-1;e>0;e--){const t=o[e];if(!t||0!==Object.keys(t).length)break;delete o[e-1][s[e-1]]}}_renderSunshineAvailabilityHint(t,s){const i=t&&t.forecast;if(!0!==i?.show_sunshine)return"";const a=this.hass,n=a?.config?a.config.latitude:null,r=a?.config?a.config.longitude:null;if(!Number.isFinite(n)||!Number.isFinite(r))return"";const c=o(n,r);if(!c)return e`<div class="hint" style="margin-top:4px;">
    ...
    `}render(){const t=e=>function(e,t){const s=e?.language||"en",o=s.split("-")[0];for(const e of[s,o,"en"]){const s=i[e]?.editor;if(s&&"string"==typeof s[t])return s[t]}return t}(this.hass,e),s=this._config??{},o=s.forecast??{},u=s.sensors??{},m=s.units??{},p=this._mode,f="combination"===p,g="forecast"===p||f,w="station"===p||f,b={humidity:"humidity",pressure:"pressure",dew_point:"dew_point",uv_index:"uv_index",wind_direction:"wind_bearing",wind_speed:"wind_speed",gust_speed:"wind_gust_speed"},y="string"==typeof s.weather_entity?s.weather_entity:"",v=y?this.hass?.states?.[y]:void 0,$=v?.attributes??{},x=this._pastDataAvailable(),C={t:t,cfg:s,fcfg:o,sensorsConfig:u,unitsConfig:m,mode:p,showsStation:w,showsForecast:g,hasSensor:e=>!!u[e],hasLiveValue:e=>{if(u[e])return!0;const t=b[e];if(!t)return!1;return null!=$[t]},pastDataAvailable:x};return e`
      ...
      <div>
        ${function(t,s){const{t:o,fcfg:i,mode:n,pastDataAvailable:r}=s,c=[{name:"mode",selector:{select:{mode:"dropdown",options:[{value:"combination",label:o("mode_combination")},{value:"station",label:o("mode_station")},{value:"forecast",label:o("mode_forecast")}]}}}],h=[{name:"type",selector:{select:{mode:"dropdown",options:[{value:"daily",label:o("forecast_type_daily")},{value:"today",label:o("forecast_type_today")},{value:"hourly",label:o("forecast_type_hourly")}]}}}];return e`
    ${a({editor:t,title:o("card_setup_heading"),sectionKey:"card_setup",resetLabel:o("reset_section")})}
    <div class="textfield-container">
      <ha-form
        ...
        @value-changed=${e=>{const s=e.detail.value?.mode;s&&s!==n&&t._setMode(s)}}
      ></ha-form>
  ...
  `}(this,C)}
    ...
    ${a({editor:t,title:o("weather_forecast_heading"),sectionKey:"weather_forecast",resetLabel:o("reset_section")})}
    <div class="textfield-container">
      <ha-form
  ...
  `}(this,C):""}
    ...
    ${a({editor:t,title:o("station_sensors_heading"),sectionKey:"sensors",resetLabel:o("reset_section")})}
  ...
  `;var l}(this,C)}
        ${function(t,s){const{t:o,cfg:i,fcfg:n,showsStation:r,showsForecast:c}=s,l=function(e,t){const s=[{name:"title",selector:{text:{}}}];return e&&s.push({name:"days",selector:{number:{min:1,max:14,mode:"box"}}}),t&&s.push({name:"forecast_days",selector:{number:{min:1,max:14,mode:"box"}}}),s}(r,c),_=function(e){return[{name:"style",selector:{select:{mode:"dropdown",options:[{value:"style2",label:e("chart_style_without_boxes")},{value:"style1",label:e("chart_style_with_boxes")}]}}},{name:"round_temp",selector:{boolean:{}}},{name:"disable_animation",selector:{boolean:{}}}]}(o),u={title:i.title||"",days:i.days,forecast_days:i.forecast_days},m={number_of_forecasts:n.number_of_forecasts},p={condition_icons:!1!==n.condition_icons,show_wind_arrow:!1!==n.show_wind_arrow,show_wind_speed:!1!==n.show_wind_speed,show_date:!1!==n.show_date,show_sunshine:!0===n.show_sunshine,show_mode_toggle:!1!==n.show_mode_toggle},f={style:n.style||"style2",round_temp:!0===n.round_temp,disable_animation:!0===n.disable_animation},g=e=>o(e.name);return e`
    ${a({editor:t,title:o("chart_section_heading"),sectionKey:"chart",resetLabel:o("reset_section")})}
  ...
  `}(this,C)}
    ...
    <!-- ─── E. Units ────────────────────────────────────────────── -->
    ${a({editor:t,title:o("units_heading"),sectionKey:"units",resetLabel:o("reset_section")})}
    <div class="textfield-container">
      <ha-form
        .data=${i}
        .schema=${l}
  ...
  `}(this,C)}
    ...
    ${a({editor:t,title:o("actions_section_heading"),sectionKey:"actions",resetLabel:o("reset_section")})}
    <div class="textfield-container">
      ${[["tap_action","tap_action_label"],["hold_action","hold_action_label"],["double_tap_action","double_tap_action_label"]].map(([s,a])=>e`
        <ha-selector
          .hass=${t.hass}
          .selector=${{ui_action:{}}}
          .value=${i[s]}
