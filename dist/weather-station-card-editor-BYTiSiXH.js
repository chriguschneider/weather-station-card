import{b as e,A as t,n as a,h as o,t as s,r as n,i,a as r,c as l,d as c,s as d,e as h,f as p,D as u,l as f}from"./main-BRQOwhZ6.js";const _=[{name:"weather_entity",required:!0,selector:{entity:{domain:"weather"}}}];function m(t){const{editor:a,sectionKey:o,icon:s,title:n,summary:i,resetLabel:r,body:l}=t;return e`
    <ha-expansion-panel
      outlined
      class="editor-panel"
  ...
  `}const v=[{path:"forecast.condition_icons",def:!0,labelKey:"show_chart_icons"},{path:"forecast.show_wind_arrow",def:!0,labelKey:"show_chart_wind_direction"},{path:"forecast.show_wind_speed",def:!0,labelKey:"show_chart_wind_speed"},{path:"forecast.show_date",def:!0,labelKey:"show_chart_date"},{path:"forecast.show_sunshine",def:!1,labelKey:"show_chart_sunshine"},{path:"forecast.show_mode_toggle",def:!0,labelKey:"show_chart_mode_toggle"}],w=e=>e.split(".").pop();function x(e,t,a){const o=e.map(e=>e.filter(e=>e!==t));for(;o.length<=a.column;)o.push([]);const s=o[a.column];return s.splice(Math.max(0,Math.min(a.index,s.length)),0,t),o}function $(e,t,a){return e<t?t-e:e>a?e-a:0}const k={ArrowUp:"up",ArrowDown:"down",ArrowLeft:"left",ArrowRight:"right"};let C=null;function S(e,t){return JSON.stringify(e)===JSON.stringify(t)}function L(e){const t=C;if(!t)return;window.removeEventListener("pointermove",t.onMove),window.removeEventListener("pointerup",t.onUp),window.removeEventListener("pointercancel",t.onCancel),t.ghost?.remove(),C=null;const o=t.active&&!S(a(t.preview),a(t.base));e&&o?t.onChange(a(t.preview)):t.rerender()}function O(e,t){if(0!==e.button)return;C&&L(!1);const a=e.currentTarget,o=a.closest(".layout-board");if(!o)return;const s=a.getBoundingClientRect(),n={token:t.token,board:o,startX:e.clientX,startY:e.clientY,grabOffsetX:e.clientX-s.left,grabOffsetY:e.clientY-s.top,pillWidth:s.width,pillHeight:s.height,label:t.label,active:!1,base:t.layout,preview:t.layout,ghost:null,onChange:t.onChange,rerender:t.rerender,onMove:e=>{const t=C;if(!t)return;if(!t.active){const a=e.clientX-t.startX,o=e.clientY-t.startY;if(a*a+o*o<36)return;t.active=!0,t.ghost=function(e){const t=document.createElement("div");return t.textContent=e.label,t.setAttribute("aria-hidden","true"),Object.assign(t.style,{position:"fixed",left:"0",top:"0",width:`${e.pillWidth}px`,boxSizing:"border-box",padding:"7px 14px",borderRadius:"16px",fontSize:"13px",lineHeight:"1.2",fontFamily:"inherit",background:"var(--primary-color, #03a9f4)",color:"var(--text-primary-color, #fff)",boxShadow:"0 4px 12px rgba(0, 0, 0, 0.3)",pointerEvents:"none",zIndex:"10000",opacity:"0.9"}),document.body.appendChild(t),t}(t),t.rerender()}e.preventDefault(),function(e,t,a){e.ghost&&(e.ghost.style.transform=`translate(${t-e.grabOffsetX}px, ${a-e.grabOffsetY}px)`)}(t,e.clientX,e.clientY);const a=function(e,t,a){if(0===t.length)return null;let o=0,s=1/0;t.forEach((t,a)=>{const n=function(e,t,a){const o=$(e,a.left,a.right),s=$(t,a.top,a.bottom);return o*o+s*s}(e.x,e.y,t.rect);n<s&&(s=n,o=a)});const n=t[o].pills.filter(e=>e.token!==a).filter(t=>(t.rect.top+t.rect.bottom)/2<e.y).length;return{column:o,index:n}}({x:e.clientX,y:e.clientY},function(e){return Array.from(e.querySelectorAll("[data-col]")).map(e=>({rect:e.getBoundingClientRect(),pills:Array.from(e.querySelectorAll("[data-token]")).map(e=>({token:e.dataset.token,rect:e.getBoundingClientRect()}))}))}(t.board),t.token);if(!a)return;const o=x(t.base,t.token,a);S(o,t.preview)||(t.preview=o,t.rerender())},onUp:()=>L(!0),onCancel:()=>L(!1)};C=n,window.addEventListener("pointermove",n.onMove),window.addEventListener("pointerup",n.onUp),window.addEventListener("pointercancel",n.onCancel)}function A(o){const{layout:s,explicit:n,labelFor:i,t:r,onChange:l,onReset:c,rerender:d}=o,h=C?.active?C.preview:s,p=C?.active?C.token:null,u=t=>e`
    <div
      ...
      role="option"
      aria-label=${i(t)}
      @pointerdown=${e=>O(e,{token:t,label:i(t),layout:s,onChange:l,rerender:d})}
      @keydown=${e=>((e,t)=>{const o=k[e.key];if(!o)return;e.preventDefault();const n=function(e,t,o){const s=e.findIndex(e=>e.includes(t));if(s<0)return e;const n=e[s].indexOf(t);let i;switch(o){case"up":if(0===n)return e;i={column:s,index:n-1};break;case"down":if(n>=e[s].length-1)return e;i={column:s,index:n+1};break;case"left":if(0===s)return e;i={column:s-1,index:Math.min(n,e[s-1].length)};break;case"right":if(s===e.length-1&&1===e[s].length)return e;i={column:s+1,index:Math.min(n,e[s+1]?.length??0)}}return a(x(e,t,i))}(s,t,o);if(n===s)return;l(n);const i=e.currentTarget.closest(".layout-board");requestAnimationFrame(()=>{i?.querySelector(`[data-token="${t}"]`)?.focus()})})(e,t)}
  ...
  `}const q=[{path:"show_temperature",def:!0},{path:"show_current_condition",def:!1},{path:"show_day",def:!1},{path:"show_date",def:!1}],P=[{path:"show_pressure",def:!0,gate:"live",gateKey:"pressure"},{path:"show_dew_point",def:!1,gate:"live",gateKey:"dew_point"},{path:"show_humidity",def:!1,gate:"live",gateKey:"humidity"},{path:"show_precipitation",def:!0,gate:"sensor",gateKey:["precipitation","precipitation_rate"]},{path:"show_zero_degree_level",def:!1,gate:"sensor",gateKey:"zero_degree_level"},{path:"show_uv_index",def:!0,gate:"live",gateKey:"uv_index"},{path:"show_illuminance",def:!1,gate:"sensor",gateKey:"illuminance"},{path:"show_wind_direction",def:!0,gate:"live",gateKey:"wind_direction"},{path:"show_wind_speed",def:!0,gate:"live",gateKey:"wind_speed"},{path:"show_wind_gust_speed",def:!1,gate:"live",gateKey:"gust_speed"},{path:"show_sun",def:!1},{path:"show_moon",def:!0}],z=["off","24h","24h_seconds","12h","12h_seconds"];function K(e,t){return t.filter(({path:t,def:a})=>a?!1!==e[t]:!0===e[t]).map(({path:e})=>e)}const U=[{name:"",type:"grid",schema:[{name:"pressure",selector:{select:{mode:"dropdown",options:["hPa","mmHg","inHg"]}}},{name:"speed",selector:{select:{mode:"dropdown",options:["km/h","m/s","mph","Bft"]}}},{name:"precipitation",selector:{select:{mode:"dropdown",options:["mm","in"]}}}]}],N={basics:["show_station","show_forecast","forecast.type","title","weather_entity"],sensors:["sensors","forecast.openmeteo_history"],chart:["days","forecast_days","forecast.number_of_forecasts","forecast.chart_height","forecast.condition_icons","forecast.show_wind_arrow","forecast.show_wind_speed","forecast.show_date","forecast.show_sunshine","forecast.show_mode_toggle","forecast.style","forecast.round_temp","forecast.disable_animation"],live_panel:["show_main","show_temperature","show_current_condition","show_time","show_time_seconds","use_12hour_format","show_day","show_date","show_attributes","show_humidity","show_pressure","show_dew_point","show_precipitation","show_uv_index","show_illuminance","show_wind_direction","show_wind_speed","show_wind_gust_speed","show_sun","show_moon","show_zero_degree_level","attributes_layout"],units:["units"],actions:["tap_action","hold_action","double_tap_action"]};customElements.define("weather-station-card-editor",class extends i{constructor(){super(...arguments),this.hass=null,this._config=null,this._setPastSource=e=>{if(!this._config)return;const t={...this._config},a={...t.forecast??{}};"openmeteo"===e?(a.openmeteo_history=!0,t.forecast=a,delete t.sensors):(delete a.openmeteo_history,0===Object.keys(a).length?delete t.forecast:t.forecast=a),this.configChanged(t),this.requestUpdate()},this._setClockMode=e=>{const t=[];"off"!==e&&t.push("show_time"),e.endsWith("_seconds")&&t.push("show_time_seconds"),e.startsWith("12h")&&t.push("use_12hour_format"),this._applyTogglePaths([{path:"show_time",def:!1},{path:"show_time_seconds",def:!1},{path:"use_12hour_format",def:!1}],t)},this._applyTogglePaths=(e,t)=>{if(!this._config)return;const a=new Set(t),o=JSON.parse(JSON.stringify(this._config));for(const{path:t,def:s}of e){const e=t.split(".").pop(),n=a.has(e);n===s?this._deleteByPath(o,t):this._setByPath(o,t,n)}this.configChanged(o),this.requestUpdate()},this._applyAttributeToggles=(e,t)=>{if(!this._config)return;if(!o(this._config))return void this._applyTogglePaths(e,t);const n=new Set(t),i=JSON.parse(JSON.stringify(this._config));let c=a(i.attributes_layout);for(const{path:t}of e){const e=s(t);if(!e)continue;const a=t.split(".").pop();c=n.has(a)?r(c,e):l(c,e),this._deleteByPath(i,t)}i.attributes_layout=c,this.configChanged(i),this.requestUpdate()},this._setAttributesLayout=e=>{if(!this._config)return;const t=JSON.parse(JSON.stringify(this._config));if(null===e){const e=new Set(n(this._config).flat());delete t.attributes_layout;for(const a of c){const o=d(a),s=!0===u[o],n=e.has(a);n===s?delete t[o]:t[o]=n}}else{t.attributes_layout=a(e);for(const e of c)delete t[d(e)]}this.configChanged(t),this.requestUpdate()},this._expandedPanels={},this._sensorsChanged=e=>{if(!this._config)return;const t=e.target;if("ha-form"!==t?.tagName.toLowerCase())return;const a=e.detail;this.configChanged({...this._config,sensors:a.value}),this.requestUpdate()},this._sensorPickerChanged=(e,t)=>{if(!this._config)return;const a={...this._config.sensors||{}};""===t||null==t?delete a[e]:a[e]=t,this.configChanged({...this._config,sensors:a}),this.requestUpdate()},this._unitsChanged=e=>{if(!this._config)return;const t=e.target;if("ha-form"!==t?.tagName.toLowerCase())return;const a=e.detail;this.configChanged({...this._config,units:a.value}),this.requestUpdate()},this._chartTopChanged=e=>{if(!this._config)return;const t=e.target;if("ha-form"!==t?.tagName.toLowerCase())return;const a=e.detail,o={...this._config};for(const[e,t]of Object.entries(a.value))void 0===t||""===t?delete o[e]:o[e]=t;this.configChanged(o),this.requestUpdate()},this._chartForecastChanged=e=>{if(!this._config)return;const t=e.target;if("ha-form"!==t?.tagName.toLowerCase())return;const a=e.detail,o={...this._config.forecast||{}};for(const[e,t]of Object.entries(a.value))void 0===t||""===t?delete o[e]:o[e]=t;this.configChanged({...this._config,forecast:o}),this.requestUpdate()},this._livePanelChanged=e=>{if(!this._config)return;const t=e.target;if("ha-form"!==t?.tagName.toLowerCase())return;const a=e.detail,o={...this._config};for(const[e,t]of Object.entries(a.value))void 0===t||""===t?delete o[e]:o[e]=t;this.configChanged(o),this.requestUpdate()},this._resetSection=e=>{if(!this._config)return;const t=N[e];if(!t)return;const a=JSON.parse(JSON.stringify(this._config));for(const e of t)this._deleteByPath(a,e);this.configChanged(a),this.requestUpdate()},this._valueChanged=(e,t)=>{if(!this._config)return;const a={...this._config},o=e.target.checked??e.target.value;if(t.includes(".")){const e=t.split(".");let s=a;for(let t=0;t<e.length-1;t++)s[e[t]]={...s[e[t]]},s=s[e[t]];s[e[e.length-1]]=o}else a[t]=o;this.configChanged(a),this.requestUpdate()},this._actionChanged=(e,t)=>{if(!this._config)return;const a={...this._config};null==t?delete a[e]:a[e]=t,this.configChanged(a),this.requestUpdate()}}static get properties(){return{_config:{type:Object},hass:{type:Object}}}setConfig(e){if(!e)throw new Error("Invalid configuration");this._config=e;const t=this.hass?.language||"en";"en"!==t&&"en"!==t.split("-")[0]&&h(t).then(()=>this.requestUpdate()),this.requestUpdate()}get config(){return this._config}get _mode(){if(!this._config)return"station";const e=!1!==this._config.show_station,t=!0===this._config.show_forecast;return e&&t?"combination":t?"forecast":"station"}_setMode(e){if(!this._config)return;const t={...this._config};switch(e){case"station":t.show_station=!0,t.show_forecast=!1;break;case"forecast":t.show_station=!1,t.show_forecast=!0;break;case"combination":t.show_station=!0,t.show_forecast=!0}this.configChanged(t),this.requestUpdate()}get _pastSource(){const e=this._config?.sensors||{};if(Object.values(e).some(e=>"string"==typeof e&&""!==e.trim()))return"station";const t=this._config?.forecast;return!0===t?.openmeteo_history?"openmeteo":"station"}get _clockMode(){const e=this._config??{};return!0!==e.show_time?"off":(!0===e.use_12hour_format?"12h":"24h")+(!0===e.show_time_seconds?"_seconds":"")}_setByPath(e,t,a){const o=t.split(".");let s=e;for(let e=0;e<o.length-1;e++){const t=s[o[e]];t&&"object"==typeof t||(s[o[e]]={}),s=s[o[e]]}s[o[o.length-1]]=a}_isPanelExpanded(e){return!0===this._expandedPanels[e]}_setPanelExpanded(e,t){this._expandedPanels[e]=t}_pastDataAvailable(){if(!this._config)return!0;const e=this._config.sensors||{},t=Object.values(e).some(e=>"string"==typeof e&&""!==e.trim()),a=this._config.forecast;return t||!0===a?.openmeteo_history}updated(e){e.has("_config")&&this._config&&!this._pastDataAvailable()&&"forecast"!==this._mode&&this._setMode("forecast")}configChanged(e){const t=new Event("config-changed",{bubbles:!0,composed:!0});t.detail={config:e},this.dispatchEvent(t)}_deleteByPath(e,t){const a=t.split("."),o=[e];let s=e;for(let e=0;e<a.length-1;e++){const t=s?.[a[e]];if(!t||"object"!=typeof t)return;s=t,o.push(s)}delete s[a[a.length-1]];for(let e=o.length-1;e>0;e--){const t=o[e];if(!t||0!==Object.keys(t).length)break;delete o[e-1][a[e-1]]}}_renderSunshineAvailabilityHint(t,a){const o=t&&t.forecast;if(!0!==o?.show_sunshine)return"";const s=this.hass,n=s?.config?s.config.latitude:null,i=s?.config?s.config.longitude:null;if(!Number.isFinite(n)||!Number.isFinite(i))return"";const r=p(n,i);if(!r)return e`<div class="hint" style="margin-top:4px;">
    ...
    `}render(){const t=e=>function(e,t){const a=e?.language||"en",o=a.split("-")[0];for(const e of[a,o,"en"]){const a=f[e]?.editor;if(a&&"string"==typeof a[t])return a[t]}return t}(this.hass,e),i=this._config??{},r=i.forecast??{},l=i.sensors??{},c=i.units??{},d=this._mode,h="combination"===d,p="forecast"===d||h,u="station"===d||h,x={humidity:"humidity",pressure:"pressure",dew_point:"dew_point",uv_index:"uv_index",wind_direction:"wind_bearing",wind_speed:"wind_speed",gust_speed:"wind_gust_speed"},$="string"==typeof i.weather_entity?i.weather_entity:"",k=$?this.hass?.states?.[$]:void 0,C=k?.attributes??{},S=this._pastDataAvailable(),L={t:t,cfg:i,fcfg:r,sensorsConfig:l,unitsConfig:c,mode:d,showsStation:u,showsForecast:p,hasSensor:e=>!!l[e],hasLiveValue:e=>{if(l[e])return!0;const t=x[e];if(!t)return!1;return null!=C[t]},pastDataAvailable:S};return e`
      <style>
        h4.subsection {
          font-size: 0.9rem;
          font-weight: 500;
  ...
  `;return m({editor:t,sectionKey:"chart",icon:"mdi:chart-line",title:o("chart_section_heading"),summary:_,resetLabel:o("reset_section"),body:g})}(this,L)}
        ${function(t,i){const{t:r,cfg:l,hasSensor:c,hasLiveValue:d}=i,h=!0===l.show_main,p=!0===l.show_attributes,u=e=>[{name:e,selector:{boolean:{}}}],f=[{name:"clock_mode",selector:{select:{mode:"dropdown",options:z.map(e=>({value:e,label:r(`clock_${e}`)}))}}}],_=function(e,t){return P.filter(({gate:a,gateKey:o})=>{if(!a||!o)return!0;const s="live"===a?e:t;return("string"==typeof o?[o]:o).some(s)})}(d,c),g=e=>({show_main:r("show_main"),show_attributes:r("show_attributes"),clock_mode:r("clock_label")}[e.name]||r(e.name)),y=function(e,t){if(!o(e))return K(e,t);const n=new Set(a(e.attributes_layout).flat());return t.filter(({path:e})=>{const t=s(e);return void 0!==t&&n.has(t)}).map(({path:e})=>e)}(l,_),v=function(t,a,i){const{t:r,cfg:l}=a,c=new Set(i.map(s).filter(e=>void 0!==e)),d=n(l).map(e=>e.filter(e=>c.has(e))).filter(e=>e.length>0);return 0===d.length?e``:A({layout:d,explicit:o(l),labelFor:e=>r(`show_${e}`),t:r,onChange:e=>t._setAttributesLayout(e),onReset:()=>t._setAttributesLayout(null),rerender:()=>t.requestUpdate()})}(t,i,y),w=`${r("main_panel_heading")} ${r(h?"summary_on":"summary_off")} · `+(p?`${y.length} ${r("summary_attributes")}`:`${r("attributes_heading")} ${r("summary_off")}`),x=e`
    <div class="textfield-container">
      <ha-form
        .data=${{show_main:h}}
        .schema=${u("show_main")}
      ...
      ${h?e`
        <div class="gated">
          ${b({label:r("main_elements_label"),group:"main_elements",options:q.map(({path:e})=>({value:e,label:r(e)})),selected:K(l,q),onChange:e=>t._applyTogglePaths(q,e)})}
          <ha-form
      ...
      <ha-form
        .data=${{show_attributes:p}}
        .schema=${u("show_attributes")}
        .hass=${t.hass}
        .computeLabel=${g}
        @value-changed=${t._livePanelChanged}
      ></ha-form>
      ${p?e`
        <div class="gated">
          ${b({label:r("attributes_heading"),group:"attributes",options:_.map(({path:e})=>({value:e,label:r(e)})),selected:y,onChange:e=>t._applyAttributeToggles(_,e)})}
          ${v}
        </div>
      `:""}
    </div>
  `;return m({editor:t,sectionKey:"live_panel",icon:"mdi:clock-outline",title:r("live_panel_heading"),summary:w,resetLabel:r("reset_section"),body:x})}(this,L)}
  ...
  `;return m({editor:t,sectionKey:"units",icon:"mdi:ruler",title:o("units_heading"),summary:n,resetLabel:o("reset_section"),body:i})}(this,L)}
  ...
  `;return m({editor:t,sectionKey:"actions",icon:"mdi:gesture-tap",title:o("actions_section_heading"),summary:i,resetLabel:o("reset_section"),body:r})}(this,L)}
